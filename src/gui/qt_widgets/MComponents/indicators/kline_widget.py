...
class KLineWidget(BaseIndicatorWidget):
    ...
    def load_qss(self):
        ...
        self.label_ma5.setStyleSheet(f"color: {dict_ma_color_hex['ma5']}")
        self.label_ma10.setStyleSheet(f"color: {dict_ma_color_hex['ma10']}")
        self.label_ma20.setStyleSheet(f"color: {dict_ma_color_hex['ma20']}")
        self.label_ma24.setStyleSheet(f"color: {dict_ma_color_hex['ma24']}")
        self.label_ma30.setStyleSheet(f"color: {dict_ma_color_hex['ma30']}")
        self.label_ma52.setStyleSheet(f"color: {dict_ma_color_hex['ma52']}")
        self.label_ma60.setStyleSheet(f"color: {dict_ma_color_hex['ma60']}")
